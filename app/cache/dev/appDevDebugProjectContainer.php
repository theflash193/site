...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'local.42.fr', 'port' => '3306', 'dbname' => 'fille_en_vert', 'user' => 'root', 'password' => 'maxgord77', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_014a71a524a55cf883c16f8524b1416005b085ca603cfa2af543189903b74675');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_014a71a524a55cf883c16f8524b1416005b085ca603cfa2af543189903b74675');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_014a71a524a55cf883c16f8524b1416005b085ca603cfa2af543189903b74675');
        ...
        $d->setProxyDir('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/src/Site/FrontEndBundle/Resources/views', 'SiteFrontEnd');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/Resources/views');
        $instance->addPath('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('edb86ed495da8a41e1059f4fb7eb3858e');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('54118d3c2a655')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev',
            'kernel.logs_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/logs',
            'kernel.bundles' => array(
                ...
                'SiteFrontEndBundle' => 'Site\\FrontEndBundle\\SiteFrontEndBundle',
            ...
            'locale' => 'fr',
            'secret' => 'edb86ed495da8a41e1059f4fb7eb3858e',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'edb86ed495da8a41e1059f4fb7eb3858e',
            ...
            'session.save_path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/profiler',
            ...
            'router.resource' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/../web',
            'assetic.write_to' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.ruby.bin' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/ruby/bin/ruby',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Data/nfs/zfs-student-2/users/2013/grass-kw/mump/apps/site/htdocs/app/cache/dev/doctrine/orm/Proxies',
